...
class-codec cells correctly, so on a 500-tile bundle the decision measures just four
percent of the tiles. Its only slip is the WebP near-break-even regime, where the
