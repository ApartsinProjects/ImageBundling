...
whole-bundle cache-invalidation problem (Appendix~A.3). HTTP
...
A live-renderer measurement (Appendix~A.2) confirms that at typical tile
...
benefit is cache granularity and bounded invalidation (Appendix~A.3,
...
deltas. This is the procedure evaluated against the oracle in Table~8.}
...
server's own QUIC transport log (Section~5.4) and
...
\subsection*{A.2\quad Local rendering cost: decode time and
memory}
...
\subsection*{A.3\quad Cache invalidation and delta
updates}
...
\subsection*{A.4\quad Choosing a rendering
mechanism}
