...
\bottomrule
\end{tabular}
\caption{Display mechanisms for a bundled tile and how they
differ in production. All four paint after a single atlas or bundle
fetch; they diverge on image semantics, accessibility, loading control,
and support. Pick the byte layout with the Section~6.2 selector and the
mechanism here.}
